-- ============================================================
-- نظام إدارة مخزن كنيسة الأنبا شنودة رئيس المتوحدين بالزرابي
...
-- 5. جدول الأصناف والمخزون (Products / Items)
...
-- 8. جدول سجل حركة المخزون الشامل (Stock Movements Log)
...
-- 9. جدول سجل الأمان والمراقبة (Audit Logs)
...
-- ============================================================
-- البيانات الإبتدائية والتجريبية (Seed Data)
-- ============================================================

-- أدوار النظام
INSERT INTO roles (id, name, description) VALUES
(1, 'مدير النظام', 'صلاحيات كاملة للتحكم في المخزن والمستخدمين والإعدادات'),
(2, 'أمين المخزن', 'صلاحيات إدخال الوارد والمنصرف وإدارة الأصناف'),
...
(1, 'admin', 'القمص شنودة - مدير المخزن', '$2a$10$e8.s/5m.U9WfXpC4I3T.eO8G0yS2k7.e89f0293jsk2', 1),
(2, 'storekeeper', 'أستاذ مينا - أمين المخزن', '$2a$10$x8.s/5m.U9WfXpC4I3T.eO8G0yS2k7.e89f0293jsk3', 2);
...
(4, 'أدوات مكتبية ومكتبة', 'الأوراق، الأقلام، والكتب والطباعة');
...
-- الفهارس لتحسين السرعة والأداء (Indexes)
